<main>
    <div class="container mx-auto pt-5">
        ...
        <section id="header" class="mb-4">
            ...
            <h4 class="text-muted mt-0 mb-6">Selamat datang, <?= $_SESSION['username'] ?>. Status: <span class="text-indigo-700 font-bold"><?php if ($_SESSION['role'] === '0'): ?>User<?php else: ?>Admin<?php endif ?></span></h4>
            <a href="<?= BASE_URL ?>/Mahasiswa/create" class="px-6 py-3 rounded bg-indigo-700 text-white text-sm font-bold whitespace-nowrap hover:bg-orange-500 focus:bg-orange-500">
                Insert
            </a>
        </section>
        <section id="main">
                                ...
                                foreach ($data['mahasiswa'] as $student):?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-1 whitespace-nowrap text-center text-lg font-medium">
                                            <a href="<?= BASE_URL ?>/Mahasiswa/edit/<?= $student['id'] ?>" class="text-indigo-600 font-bold hover:text-indigo-900 mr-8">Edit</a>
                                            <?php if($_SESSION['role'] === '1'): ?>
                                                <form action="<?= BASE_URL ?>/Mahasiswa/delete/<?= $student['id'] ?>" id="form-hapus" class="inline">
