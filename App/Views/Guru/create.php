        ...
        <div class="mt-10 sm:mt-0">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <form action="<?= BASE_URL ?>/Guru/insert" method="POST" enctype="multipart/form-data">
                        <div class="shadow overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-2">
                                        <label for="kode_guru" class="block text-sm font-medium text-gray-700">Kode Guru</label>
                                        <input type="text" name="kode_guru" id="kode_guru" autocomplete="off" required class="form-input px-4 py-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
