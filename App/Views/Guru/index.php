<main>
    <div class="container mx-auto pt-5">
        ...
        <section id="header" class="mb-4">
            ...
            <a href="<?= BASE_URL ?>/Guru/create" class="px-6 py-3 rounded bg-indigo-700 text-white text-sm font-bold whitespace-nowrap hover:bg-orange-500 focus:bg-orange-500">
                Tambah Data
            </a>
        </section>
        <section id="main">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                foreach ($data['guru'] as $teacher):?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-1 whitespace-nowrap">
                                            <div class="text-sm text-gray-900"><?= $teacher['nama'] ?></div>
                                        </td>
